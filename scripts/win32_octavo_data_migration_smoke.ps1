...
$PassLine = $Output | Where-Object {
  $_ -match '^octavo_data_migration_smoke result=pass '
...
Write-Host $PassLine
Write-Host "win32_octavo_data_migration_smoke result=pass legacy=preserved current=8vo idempotent=marker unsupported=ignored retry=verified"
