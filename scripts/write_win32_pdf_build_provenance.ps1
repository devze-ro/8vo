...
$sourceFiles = @(
  "code\build.c",
  "code\octavo.c",
  "code\platform\win32\octavo_accessibility_win32.h",
  "code\platform\win32\octavo_accessibility_win32.c",
  "code\octavo_pdf.h",
  "code\octavo_pdf.c",
  "code\octavo_pdf_content.h",
  "code\octavo_pdf_content.c",
  "code\octavo_pdf_selection.h",
  "code\octavo_pdf_selection.c",
  ...
  "scripts\win32_octavo_pdf_content_smoke.ps1",
