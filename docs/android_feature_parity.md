...
The tenth independent Port 11 local slice accepts synchronized-Library
membership on API 36. Canonical causal `O1LM` and private atomic `O1MS` stay
separate from catalog discovery, managed transfer, Port 6, and every earlier
family. Focused membership coverage passes 31/31 in 42 seconds, the complete
ordinary matrix passes 344/344 in 9m12s, and crash/fatal buffers are empty. The
product APK declares zero permissions. No physical device, provider/account/
